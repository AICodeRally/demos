/* ══════════════════════════════════════════════════════════
   PROOFLINE Route Data — Route KC-01 (Kansas City)

   Rep: Marcus Reyes
   Territory: Kansas City Metro
...
export type LicenseStatus = 'verified' | 'expiring' | 'flagged';
...
export const STRATEGY_TAG_CONFIG: Record<StrategyTag, { label: string; color: string; icon: string }> = {
  ...
  'volume-tier':     { label: 'VOLUME TIER',      color: '#f59e0b', icon: '\u{1F4E6}' },
};
...
export const ROUTE_STOPS: RouteStop[] = [
  ...
  },
  {
    ...
    intelligence: {
      insights: [
        'Nielsen: Patron Silver up 40% in 64110 zip (Q1 2026)',
        'CRM: Owner mentioned expanding spirits section by April',
        'Foot traffic up 18% since new parking lot completed',
      ],
      competitiveIntel: 'Heartland Beverage Co placed a Maker\'s Mark display last week — counter with Buffalo Trace prominence.',
    ...
    aiSuggestions: [
      ...
      {
        id: 'sug-2b', product: 'Hennessy VS Cognac 750ml', productId: 'ls-006', cases: 3, commissionDelta: 29,
        reasoning: 'No cognac on shelf currently. Demographic data shows strong demand in area.',
        source: 'MO Liquor Control Database + Demographics', tags: ['spirits', 'premium'], strategy: 'margin-priority',
  ...
  },
  {
    ...
    intelligence: {
      insights: [
        'Chain HQ mandate: increase Missouri craft by 15% in Q2',
  ...
  },
  {
    id: 'stop-4',
    sequence: 4,
    accountName: 'Royal Liquor Mart',
    type: 'presell',
    arrivalTime: '10:00 AM',
    address: '2941 Elm St, Kansas City, MO 75226',
    lat: 39.168, lng: -94.615,
    manifest: [
    ...
    aiSuggestions: [
      {
        id: 'sug-4a', product: 'Buffalo Trace Bourbon 750ml', productId: 'ls-001', cases: 4, commissionDelta: 22,
        reasoning: 'Owner expanding bourbon. Buffalo Trace has allocation advantage — limited availability creates urgency.',
        source: 'CRM Notes + Allocation Data', tags: ['spirits', 'premium'], strategy: 'margin-priority',
  ...
  },
  {
    ...
    aiSuggestions: [
      {
        id: 'sug-5a', product: 'Fever-Tree Tonic Water 8pk', productId: 'ls-018', cases: 4, commissionDelta: 12,
        reasoning: 'Owner interested in premium cocktails. Fever-Tree is #1 premium mixer. $4/margin per case.',
        source: 'CRM + Category Trends', tags: ['premium'], strategy: 'mix-shift',
      ...
      {
        id: 'sug-5b', product: 'Patron Silver Tequila 750ml', productId: 'ls-005', cases: 2, commissionDelta: 32,
        reasoning: 'Margarita mix volume suggests tequila demand. Patron premium positioning for cocktail menu.',
        source: 'Sales Velocity Analysis', tags: ['spirits', 'premium'], strategy: 'margin-priority',
  ...
  },
  {
    ...
    aiSuggestions: [
      {
        id: 'sug-6a', product: 'Hennessy VS Cognac 750ml', productId: 'ls-006', cases: 2, commissionDelta: 34,
        reasoning: 'New account bonus ($100) + spirits SPIFF ($25x2). Premium cocktail bar needs cognac for menu.',
        source: 'New Account Program', tags: ['spirits', 'premium', 'new-account'], strategy: 'new-pipeline',
      ...
      {
        id: 'sug-6c', product: 'Blue Moon Belgian White 12pk', productId: 'ls-011', cases: 3, commissionDelta: 11,
        reasoning: 'Crossover appeal for craft cocktail crowd. High margin craft beer with national recognition.',
        source: 'Category Strategy', tags: ['premium'], strategy: 'mix-shift',
  ...
  },
  {
    ...
    aiSuggestions: [
      {
        id: 'sug-7a', product: 'Patron Silver Tequila 750ml', productId: 'ls-005', cases: 4, commissionDelta: 47,
        reasoning: 'Cinco de Mayo bundle: Patron + Margarita Mix cross-sell. Nielsen: Patron up 55% in this zip.',
        source: 'Nielsen + Seasonal Calendar', tags: ['spirits', 'premium'], strategy: 'placement',
  ...
  },
  {
    ...
    intelligence: {
      ...
      competitiveIntel: 'Pecan Valley Spirits is pushing Smirnoff at aggressive pricing. Defend Fireball position.',
      contactName: 'Sam Patel (Owner)',
      contactPhone: '(816) 555-0808',
      tabcStatus: 'flagged',
    ...
    aiSuggestions: [
      {
        id: 'sug-8a', product: 'Fireball Cinnamon Whisky 750ml', productId: 'ls-002', cases: 6, commissionDelta: 15,
        reasoning: 'Push to 50 total cases this delivery \u2192 unlocks 4% volume tier. Fireball is guaranteed sell-through.',
        source: 'Tier Optimization + Sales Velocity', tags: ['spirits'], strategy: 'volume-tier',
