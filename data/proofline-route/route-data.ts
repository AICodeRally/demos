...
export const ROUTE_STOPS: RouteStop[] = [
  {
    ...
    intelligence: {
      ...
      competitiveIntel: 'Magnolia Spirits Group ran a promo blitz in 75201 zip last week — expect requests for price matching.',
  ...
  },
  {
    ...
    intelligence: {
      ...
      competitiveIntel: 'Magnolia Spirits Group placed a Maker\'s Mark display last week — counter with Buffalo Trace prominence.',
    ...
    aiSuggestions: [
      ...
      },
      {
        ...
        source: 'TABC Database + Demographics', tags: ['spirits', 'premium'], strategy: 'margin-priority',
