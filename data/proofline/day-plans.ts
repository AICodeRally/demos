...
export const MARCUS_DAY_PLAN: DayPlan = {
  ...
  stops: [
    ...
    // Stop 2: Key Account — Spec's Liquors Greenville
    {
      ...
      competitiveIntel: 'Redtail delivered 3 pallets Tuesday last week — appears to be pushing Constellation directly. Monitor for pricing conflicts.',
    ...
    // Stop 3: Chain Drop — Kroger #4412
    {
      ...
      competitiveIntel: 'Iron Creek has Miller Lite promotional display in lobby — check pricing against ours.',
    ...
    // Stop 4: Presell — Cedar Springs Tap House
    {
      ...
      competitiveIntel: 'Redtail sales rep spotted here Tuesday AM last month. They have 2 of 8 taps (Goose Island, Kona). Target the remaining 3 open taps.',
    ...
    // Stop 5: New Account — Deep Ellum Bottle Shop
    {
      ...
      competitiveIntel: 'No existing distributor relationship — this is a greenfield account. Redtail and Iron Creek have not visited yet per owner.',
    ...
    // Stop 8: Presell + Spirits — The Statler Hotel Bar
    {
      ...
      competitiveIntel: 'Magnolia Spirits Group supplies Maker\'s Mark and Woodford Reserve. Position Buffalo Trace as better margin alternative ($4/bottle lower cost).',
