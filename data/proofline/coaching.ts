...
export const COACHING_CARDS: CoachingCard[] = [
  ...
  {
    id: 'CC-002',
    sellerId: 'SEL-DAL-07', sellerName: 'Jackie Hernandez', routeId: 'DAL-07',
    ...
    dataPoints: [
      ...
      'Jackie has been a Tier 4 rep for 8 months — this is unusual',
    ],
  ...
  {
    id: 'CC-004',
    sellerId: 'SEL-DAL-06', sellerName: 'Ana Washington', routeId: 'DAL-06',
  ...
  {
    id: 'CC-005',
    sellerId: 'SEL-DAL-08', sellerName: 'Nathan Chowdhury', routeId: 'DAL-08',
    category: 'compliance', priority: 'high', status: 'new',
    title: 'Nathan\'s display compliance dropped to 71%',
    description: 'Nathan (DAL-08) display compliance has dropped from 88% to 71% over the last 3 weeks. 4 key accounts are now non-compliant. His route has the lowest compliance in the Dallas district.',
    dataPoints: [
      ...
      'Nathan has not submitted compliance photos in 8 days',
      'Cold vault share on route: 34% (target: 40%)',
    ],
    suggestedAction: 'Schedule compliance ride-along with Nathan this week. Review photo verification requirements. Check if issue is time management (rushing through stops) or disengagement. Consider whether route needs rebalancing — DAL-08 has 15% more accounts than average.',
  ...
  {
    id: 'CC-006',
    sellerId: 'SEL-DAL-05', sellerName: 'Andre Patel', routeId: 'DAL-05',
    category: 'development', priority: 'medium', status: 'in-progress',
    title: 'Andre ready for Tier 2 promotion assessment',
    description: 'Andre (DAL-05) has been at Tier 3 for 6 months but his last 4 weeks show Tier 2-level performance. Attainment trending from 0.82 to 0.91. Spirits accounts growing.',
    dataPoints: [
    ...
    suggestedAction: 'Schedule formal Tier promotion review. Andre has met all criteria for 4 consecutive weeks. Prepare promotion paperwork. Pair with Derek for final mentoring on spirits execution. Announce at next team meeting if approved.',
...
export const DALLAS_DISTRICT_LIVE: DistrictRepSnapshot[] = [
  ...
  { sellerId: 'SEL-DAL-05', sellerName: 'Andre Patel', routeId: 'DAL-05', currentStop: 5, totalStops: 10, casesDelivered: 220, casesTarget: 320, revenueToday: 10800, onTimeRate: 0.88, attainment: 0.91, status: 'on-track', statusColor: 'green' },
  { sellerId: 'SEL-DAL-06', sellerName: 'Ana Washington', routeId: 'DAL-06', currentStop: 4, totalStops: 11, casesDelivered: 195, casesTarget: 340, revenueToday: 9200, onTimeRate: 0.82, attainment: 0.95, status: 'behind', statusColor: 'amber' },
  { sellerId: 'SEL-DAL-07', sellerName: 'Jackie Hernandez', routeId: 'DAL-07', currentStop: 3, totalStops: 10, casesDelivered: 145, casesTarget: 350, revenueToday: 6800, onTimeRate: 0.78, attainment: 0.91, status: 'issue', statusColor: 'red' },
  { sellerId: 'SEL-DAL-08', sellerName: 'Nathan Chowdhury', routeId: 'DAL-08', currentStop: 5, totalStops: 10, casesDelivered: 200, casesTarget: 310, revenueToday: 8900, onTimeRate: 0.85, attainment: 0.87, status: 'behind', statusColor: 'amber' },
];
