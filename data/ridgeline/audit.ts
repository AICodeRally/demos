// SRS Distribution — Audit Trail Data
...
export const AUDIT_EVENTS: AuditEvent[] = [
  ...
  },
  {
    ...
    details: 'TX North territory expanded: 3 Heritage branches integrated (b-016, b-017, b-018 reassigned from Heritage East).',
  ...
  },
  {
    ...
    details: 'Q1 quota pro-rated for Michael Torres. Heritage branch integration added $4.2M to territory mid-quarter.',
  ...
  },
  {
    ...
    details: 'February 2026 payout batch approved. 847 reps, $2.34M total incentive. Varicent calc verified.',
  ...
  },
  {
    ...
    details: 'Nathan Cole February SPIFF reversed. Product category mapping error in Varicent feed — Heritage shingles miscoded as GAF.',
  ...
  },
  {
    ...
    metadata: { disputeAmount: 12300, orderId: 'SRS-91204', returnPct: 30 },
    approvedBy: null,
    severity: 'critical',
  },
  {
  ...
  },
  {
    ...
    entityId: 'feed-varicent-daily',
    actor: 'System',
    actorRole: 'Automated',
    timestamp: '2026-03-12T06:15:00Z',
    details: 'Varicent daily transaction feed failed validation. 247 records with null branch_id. ERP sync delay detected.',
    metadata: { recordsTotal: 14820, recordsFailed: 247, errorType: 'null_branch_id', feedName: 'erp-to-varicent' },
    approvedBy: null,
    severity: 'critical',
  },
  {
    ...
    details: 'Heritage Philadelphia (HER-0401) integrated into SRS Core reporting. Comp plan migration: Heritage BM Plan → SRS BM Plan.',
    metadata: { previousDivision: 'heritage', newDivision: 'srs-core', planMigrated: 'true' },
