...
import type {
  ...
  D365TenderLine,
  D365StoreContext,
} from '@/data/register/d365-schemas';
...
export function generateTransactionEvent(
  ...
  return {
    ...
    beginDateTime: new Date(now.getTime() - 180000).toISOString(),
