...
export const LONE_STAR_CONFIG: ClientConfig = {
  id: 'lone-star-spirits',
  name: 'Lone Star Spirits',
  logo: 'lone-star-spirits',

  theme: {
    primary: '#0f1729',       // dark navy
    secondary: '#1e293b',     // slate panel bg
    background: '#0a0f1e',    // deep navy bg
    text: '#f1f5f9',
    accent: '#C6A052',        // PROOFLINE Gold
  },
  ...
  components: [
    {
      ...
      rule: {
        ...
        marginal: true,
        tiers: [
          { min: 0, rate: 0.03 },       // 3% up to 500 cases/mo
          { min: 500, rate: 0.04 },      // 4% 500-1000 cases
          { min: 1000, rate: 0.05 },     // 5% 1000+ cases
        ],
      },
    },
    {
...
export const LONE_STAR_REPS = [
  { id: 'ls-rep-001', name: 'Marcus Reyes', storeId: 'DAL-03' },
  { id: 'ls-rep-002', name: 'Jake Thompson', storeId: 'DAL-07' },
  { id: 'ls-rep-003', name: 'Christina Morales', storeId: 'FTW-01' },
];
