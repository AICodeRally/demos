      ...
      <div style={{ display: 'grid', gridTemplateColumns: savedScores.length > 0 ? '1fr 320px' : '1fr', gap: '20px' }}>
        <div className="space-y-6">
          <div className="rounded-xl bg-white border p-6" style={{ borderColor: '#E7E5E4' }}>
            ...
            <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-4">
              <div>
                <label className="text-xs font-semibold uppercase tracking-wider block mb-1" style={{ color: '#78716C' }}>Year</label>
                <input
                  type="number"
                  ...
                  style={{ backgroundColor: '#F8FAFC', border: '1px solid #E7E5E4', color: '#1C1917' }}
                />
              </div>
              <div>
                <label className="text-xs font-semibold uppercase tracking-wider block mb-1" style={{ color: '#78716C' }}>Make</label>
                <input
                  type="text"
              ...
              <div>
                <label className="text-xs font-semibold uppercase tracking-wider block mb-1" style={{ color: '#78716C' }}>Model</label>
                <input
                  type="text"
              ...
              <div>
                <label className="text-xs font-semibold uppercase tracking-wider block mb-1" style={{ color: '#78716C' }}>Trim</label>
                <input
                  type="text"
                  readOnly
                  value="XLE"
              ...
              <div>
                <label className="text-xs font-semibold uppercase tracking-wider block mb-1" style={{ color: '#78716C' }}>Mileage</label>
                <input
                  type="number"
              ...
              <div>
                <label className="text-xs font-semibold uppercase tracking-wider block mb-1" style={{ color: '#78716C' }}>Source</label>
                <input
                  type="text"
                  readOnly
              ...
              <div>
                <label className="text-xs font-semibold uppercase tracking-wider block mb-1" style={{ color: '#78716C' }}>Asking Price</label>
                <input
                  type="number"
        ...
        {savedScores.length > 0 && (
          <div className="space-y-3">
            <h3 className="text-base font-bold" style={{ color: '#1C1917' }}>Saved Scores</h3>
            {savedScores.map((saved, idx) => (
              ...
              >
                ...
                <div className="text-xs space-y-0.5" style={{ color: '#78716C' }}>
