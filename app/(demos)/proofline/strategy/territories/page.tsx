  ...
  return (
    <>
      ...
      <LightSectionCard title="Territory Heatmap — Attainment by Hometown" className="mb-6">
        ...
        {/* Legend */}
        <div className="flex items-center justify-center gap-6 mt-2 text-xs font-mono" style={{ color: '#718096' }}>
            ...
            <Link key={h.id} href={`/proofline/strategy/territories/${h.id}`} className="group">
              ...
              >
                <div className="flex items-start justify-between mb-3">
                  <div>
                    <div className="flex items-center gap-2 mb-1">
                      <h3 className="text-[15px] font-bold" style={{ color: '#1A1A2E', fontFamily: 'var(--pl-font)' }}>
                        {h.name}
                      </h3>
                      <span
                ...
                <div className="grid grid-cols-4 gap-3 mb-3">
                  <div>
                    <div className="text-xs uppercase tracking-wider font-mono" style={{ color: '#718096' }}>Routes</div>
                    <div className="text-[15px] font-bold" style={{ color: '#1A1A2E' }}>{h.routes}</div>
                  </div>
                  <div>
                    <div className="text-xs uppercase tracking-wider font-mono" style={{ color: '#718096' }}>Attainment</div>
                    <div className="text-[15px] font-bold" style={{ color: tier.color }}>{pct(avgAttain)}</div>
                  </div>
                  <div>
                    <div className="text-xs uppercase tracking-wider font-mono" style={{ color: '#718096' }}>Revenue</div>
                    <div className="text-[15px] font-bold" style={{ color: '#1A1A2E' }}>{fmtM(h.rev * 4)}</div>
                  </div>
                  <div>
                    <div className="text-xs uppercase tracking-wider font-mono" style={{ color: '#718096' }}>Cases</div>
                ...
                <div className="text-[13px] font-mono mt-2" style={{ color: '#A0AEC0' }}>
