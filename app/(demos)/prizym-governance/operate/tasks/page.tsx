          ...
          return (
            ...
            >
              <div style={{
                ...
                <span style={{ fontSize: 14, fontWeight: 700, color: config.color, textTransform: 'uppercase', letterSpacing: '0.05em' }}>
                  {config.label}
                </span>
                <span style={{
                  marginLeft: 'auto', padding: '2px 8px', borderRadius: 10,
                  background: config.color, color: '#fff', fontSize: 14, fontWeight: 700,
                }}>{tasks.length}</span>
              </div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
                ...
                {tasks.length === 0 && (
                  <div style={{ padding: 20, textAlign: 'center', color: 'var(--pg-text-muted)', fontSize: 14, fontStyle: 'italic', border: '1px dashed var(--pg-border)', borderRadius: 8 }}>
                    No tasks
                  </div>
                )}
              </div>
