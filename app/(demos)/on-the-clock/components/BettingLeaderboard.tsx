    ...
    <div className="flex flex-col items-center w-full h-full px-4 py-4 overflow-y-auto">
      ...
      {entries.length === 0 ? (
        <div className="text-center py-8">
          ...
          <p className="text-xs text-slate-600 mt-1">Complete a draft with betting to appear here</p>
        </div>
      ) : (
        <div className="w-full max-w-[460px]">
          {/* Column headers */}
          <div className="flex items-center gap-2 px-3 py-1.5 border-b border-white/10 text-[9px] text-slate-600 uppercase tracking-wider font-bold">
