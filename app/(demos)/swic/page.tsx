...
const INDUSTRIES = [
  ...
  { name: 'Lone Star Spirits', industry: 'Beverage Distribution', color: '#C6A052', id: 'lone-star-spirits' },
];

const EMBED_CODE = `<iframe
  src="https://demo.swic-summit.aicoderally.com/widget?client=lone-star-spirits&theme=dark"
  width="400"
  height="600"
...
export default function LandingPage() {
  return (
    <div className="min-h-screen mesh-bg-light">
      ...
      <section className="max-w-6xl mx-auto px-6 py-16">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3">
          {INDUSTRIES.map((ind) => (
            <Link
              key={ind.id}
              href={ind.id === 'lone-star-spirits' ? '/proofline-route' : `/simulator?client=${ind.id}`}
      ...
      {/* PROOFLINE Route Demo CTA */}
      <section className="max-w-4xl mx-auto px-6 pb-8">
        <Link
          href="/swic/proofline-route"
        ...
        >
          <div className="flex items-center gap-3 mb-2">
            ...
            <span className="text-sm" style={{ color: 'var(--page-muted)' }}>PROOFLINE Route Commission</span>
          </div>
          <h3 className="text-lg font-bold mb-1">Lone Star Spirits — Route DAL-03</h3>
      ...
      <section className="max-w-6xl mx-auto px-6 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
          ...
          <div>
            ...
            >
              <iframe
                src="/widget?client=lone-star-spirits&theme=dark"
                width="100%"
                height="100%"
                style={{ border: 'none' }}
