...
export function PulseCard({ card }: { card: PulseCardData }) {
  ...
  return (
    <div
      className="relative rounded-xl border border-gray-100 bg-white shadow-[0_1px_3px_rgba(37,99,235,0.06)] transition-all duration-200"
    ...
    >
      <div className="p-5">
        ...
        {expanded && (
          <p className="mt-2 rounded-lg bg-blue-50/50 p-3 text-xs text-gray-700">
            {card.whyItMatters}
          </p>
        )}
