...
const RALLY_STARTER_TEAM: OrgMember[] = [
  { id: 'tm-rt', name: 'Richard Tollefson', title: 'CEO', company: 'Phoenix Philanthropy Group', role: 'Sponsor', weight: 5 },
  ...
  return {
    ...
    capture: {
      notes: isRallyStarter ? [
        ...
        { id: 'c-9', text: 'Knack (NAC) CRM has 3,940 records — exports to Constant Contact are manual. Need automation.', author: 'Natalie Graff', tags: ['pain-point'], timestamp: now, source: 'transcript-parse' },
        ...
        { id: 'c-20', text: 'Knack data migration to relational DB — 3,940 records across 22 categories. AI dedup running in parallel.', author: 'Natalie Graff', tags: ['action-item'], timestamp: now, source: 'transcript-parse' },
        ...
        { id: 'c-27', text: 'Academy content repository: ~500 files, ~20 modules, ~20 years in Dropbox. No version control, inconsistent naming. Pain ratings 4-5/5. CSU Chancellor pilot.', author: 'Dr. Michal Tyra', tags: ['pain-point'], timestamp: now, source: 'academy-intake' },
    ...
    decisions: { items: isRallyStarter ? [
      ...
      { id: 'd-9', text: 'Academy content repository modernization: Track/Module/Topic taxonomy, AI-assisted tagging, CSU pilot first', tags: ['decision'], votes: [{ memberId: 'tm-mt', value: 'up' }, { memberId: 'tm-rt', value: 'up' }], status: 'open', createdAt: now },
    ] : [] },
    workboard: { tasks: isRallyStarter ? [
      ...
      { id: 'w-13', title: 'Academy content repository modernization — 500 files, CSU pilot', priority: 'P1', status: 'in-progress', linkedDecisionId: 'd-9', createdAt: now },
