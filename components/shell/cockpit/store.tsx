...
const BHG_STARTER_SCOPE: ModuleScope[] = [
  ...
  { id: 'bs-partners', department: 'Sales', moduleName: 'Channel Partner Portal', description: 'Sub-client management for channel partners (Andrews, Henry Schein, Jamf, KPMG, Verizon). Branded dashboards per partner', priority: 10 },
