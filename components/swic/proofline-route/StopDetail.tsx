...
import type { RouteStop } from '@/lib/swic/data/proofline-route-data';
import { STOP_TYPE_COLORS, STOP_TYPE_LABELS, STRATEGY_TAG_CONFIG } from '@/lib/swic/data/proofline-route-data';
...
export function StopDetail({ stop, slideDirection, onSwipeLeft, onSwipeRight }: StopDetailProps) {
  ...
  return (
    <div
      ...
      {...swipeHandlers}
    >
      {/* Section title — aligns with StopList "Stops" header */}
