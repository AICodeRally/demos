...
const NAV_ITEMS = [
  { href: '/summit-sleep', label: 'Tablet POS', icon: Tablet },
  { href: '/summit-sleep/manager', label: 'Manager', icon: LayoutDashboard },
  { href: '/summit-sleep/integration', label: 'Integration', icon: FileCode2 },
] as const;
