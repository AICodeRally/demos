...
import { SAMPLE_PERIODS, SUMMIT_SLEEP_CONFIG } from '@/lib/swic/data/summit-sleep';
 ...
 *
 * Uses tier definitions from SUMMIT_SLEEP_CONFIG (the base-comm tiered rule)
...
export function TierDistribution({ sales }: ManagerComponentProps) {
  const buckets: TierBucket[] = useMemo(() => {
    ...
    const baseComp = SUMMIT_SLEEP_CONFIG.components.find((c) => c.id === 'base-comm');
